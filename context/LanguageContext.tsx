...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.items': 'items',
    'home.activeSales': 'Active Sales',
    'home.dontMissOut': "Don't Miss Out",
    'home.shopAllSales': 'Shop All Sales',
    'home.productsIncluded': 'products included',
  ...
  gr: {
    ...
    'home.items': 'αντικείμενα',
    'home.activeSales': 'Ενεργές Εκπτώσεις',
    'home.dontMissOut': 'Μην το Χάσετε',
    'home.shopAllSales': 'Δείτε Όλες τις Εκπτώσεις',
    'home.productsIncluded': 'προϊόντα περιλαμβάνονται',
    'home.shopNow': 'Αγορά Τώρα',

...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.title1': 'SNEAKER',
    'home.title2': 'AIR',
    'home.subtitle': 'Step Into The Future',
    'home.subtitle2': 'Premium sneakers for those who move different',
    ...
    'home.dresses': 'Running',
    'home.tops': 'Basketball',
    'home.pants': 'Lifestyle',
    'home.skirts': 'Skate',
    'home.outerwear': 'Training',
    'home.accessories': 'Limited',
    'home.items': 'items',
    ...
    'home.testimonial': '"The quality is exceptional. Every pair I\'ve bought has become a staple in my rotation. SNEAKER AIR truly understands street style."',
    ...
    'home.hours': 'Hours',
    'home.address': '88 Sneaker Boulevard, Athens 10552, Greece',
    'home.phone': '+30 210 555 0199',
    'home.email': 'hello@sneakerair.com',
    ...
    'product.modelWearing': 'Model is wearing size EU 42',
    ...
    'footer.address': '88 Sneaker Boulevard, Athens 10552, Greece',
    'footer.phone': '+30 210 555 0199',
    'footer.email': 'hello@sneakerair.com',
    'footer.rights': '© 2026 SNEAKER AIR. All rights reserved.',
  ...
  gr: {
    ...
    'home.title1': 'SNEAKER',
    'home.title2': 'AIR',
    'home.subtitle': 'Μπες στο Μέλλον',
    'home.subtitle2': 'Premium sneakers για όσους κινούνται διαφορετικά',
    ...
    'home.dresses': 'Τρέξιμο',
    'home.tops': 'Μπάσκετ',
    'home.pants': 'Lifestyle',
    'home.skirts': 'Skate',
    'home.outerwear': 'Προπόνηση',
    'home.accessories': 'Limited',
    ...
    'home.testimonial': '"Η ποιότητα είναι εξαιρετική. Κάθε ζευγάρι που αγόρασα έχει γίνει απαραίτητο στη συλλογή μου. Το SNEAKER AIR πραγματικά καταλαβαίνει το street style."',
    ...
    'home.hours': 'Ωράριο',
    'home.address': '88 Sneaker Boulevard, Αθήνα 10552, Ελλάδα',
    'home.phone': '+30 210 555 0199',
    'home.email': 'hello@sneakerair.com',
    ...
    'product.modelWearing': 'Το μοντέλο φοράει μέγεθος EU 42',
    ...
    'footer.address': '88 Sneaker Boulevard, Αθήνα 10552, Ελλάδα',
    'footer.phone': '+30 210 555 0199',
    'footer.email': 'hello@sneakerair.com',
    'footer.rights': '© 2026 SNEAKER AIR. Με επιφύλαξη παντός δικαιώματος.',
